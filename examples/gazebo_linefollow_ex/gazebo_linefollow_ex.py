...
plt.ion()
fig, ax = plt.subplots(num="simulation_graph")
ax.set_title("simulation_graph")
ax.set_xlabel("Episodes")
ax.set_ylabel("episode_rewards")
(line_plot,) = ax.plot([], [], linewidth=2)   # single blue line
...
if __name__ == '__main__':
    ...
    for x in range(total_episodes):
        ...
        line_plot.set_data(xs, episode_rewards)
        ax.relim()
        ax.autoscale_view()
